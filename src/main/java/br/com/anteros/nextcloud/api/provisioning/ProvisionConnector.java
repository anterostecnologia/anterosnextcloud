...
public class ProvisionConnector {
	 ...
	 * @param password password needs to meet nextcloud criteria or operation will
	 *                 fail
	...
	public CompletableFuture<UserXMLAnswer> getUserAsync(String userId) {
		return connectorCommon.executeGet(USERS_PART + "/" + userId, Collections.emptyList(),
				XMLAnswerParser.getInstance(UserXMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> editUserAsync(String userId, UserData key, String value) {
		...
		return connectorCommon.executePut(USERS_PART, userId, queryParams,
	...
	public CompletableFuture<XMLAnswer> enableUserAsync(String userId) {
		return connectorCommon.executePut(USERS_PART, userId + "/enable", null,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> disableUserAsync(String userId) {
		return connectorCommon.executePut(USERS_PART, userId + "/disable", null,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<GroupsXMLAnswer> getGroupsOfUserAsync(String userId) {
		return connectorCommon.executeGet(USERS_PART + "/" + userId + "/groups", null,
				XMLAnswerParser.getInstance(GroupsXMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> addUserToGroupAsync(String userId, String groupId) {
		...
		return connectorCommon.executePost(USERS_PART + "/" + userId + "/groups", queryParams,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> removeUserFromGroupAsync(String userId, String groupId) {
		List<NameValuePair> queryParams = Collections.singletonList(new BasicNameValuePair("groupid", groupId));
		return connectorCommon.executeDelete(USERS_PART, userId + "/groups", queryParams,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<ListXMLAnswer> getSubadminGroupsOfUserAsync(String userId) {
		return connectorCommon.executeGet(USERS_PART + "/" + userId + "/subadmins", null,
				XMLAnswerParser.getInstance(ListXMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> promoteToSubadminAsync(String userId, String groupId) {
		List<NameValuePair> queryParams = Collections.singletonList(new BasicNameValuePair("groupid", groupId));
		return connectorCommon.executePost(USERS_PART + "/" + userId + "/subadmins", queryParams,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> demoteSubadminAsync(String userId, String groupId) {
		List<NameValuePair> queryParams = Collections.singletonList(new BasicNameValuePair("groupid", groupId));
		return connectorCommon.executeDelete(USERS_PART, userId + "/subadmins", queryParams,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<XMLAnswer> sendWelcomeMailAsync(String userId) {
		return connectorCommon.executePost(USERS_PART + "/" + userId + "/welcome", null,
				XMLAnswerParser.getInstance(XMLAnswer.class));
	}
	...
	public CompletableFuture<UsersXMLAnswer> getMembersOfGroupAsync(String groupId) {
		return connectorCommon.executeGet(GROUPS_PART + "/" + groupId, null,
				XMLAnswerParser.getInstance(UsersXMLAnswer.class));
	}
	...
	public CompletableFuture<ListXMLAnswer> getSubadminsOfGroupAsync(String groupId) {
		return connectorCommon.executeGet(GROUPS_PART + "/" + groupId + "/subadmins", null,
				XMLAnswerParser.getInstance(ListXMLAnswer.class));
	}
